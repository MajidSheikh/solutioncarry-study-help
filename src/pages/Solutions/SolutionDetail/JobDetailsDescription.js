...
const JobDetailsDescription = () => {
    return (
        <React.Fragment>
                                <Card className="job-detail overflow-hidden">
                                        ...
                                        <CardBody className="p-4">
                                            <div>
                                                <Row>
                                                    <Col lg={7}>
                                <h5 className="mb-1">Trusted by 2+ million users,</h5>
                                                        <ul className="list-inline text-muted mb-0">
                                                            <li className="list-inline-item">
                                        <i className="mdi mdi-account"></i> 1000+ happy students everyday
                                                            </li> <br/>
                                ...
                                <button type="button" class="btn btn-primary float-end">Download This Document</button>
                                                    </Col>
                                                </Row>
                                            </div>
